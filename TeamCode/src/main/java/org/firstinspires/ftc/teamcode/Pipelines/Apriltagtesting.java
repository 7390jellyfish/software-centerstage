...
import static org.firstinspires.ftc.vision.apriltag.AprilTagProcessorImpl.*;
...
public class Apriltagtesting extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        for(AprilTagDetection detection : detections)
        {
            ...
            drawAxisMarker(input, 0.166/2.0, 6, pose.rvec, pose.tvec, cameraMatrix);
            draw3dCubeMarker(input, 0.166, 0.166, 0.166, 5, pose.rvec, pose.tvec, cameraMatrix);
        }
    ...
    void constructMatrix()
    {
        ...
        cameraMatrix.put(0,0, 578.272);
        cameraMatrix.put(0,1,0);
        cameraMatrix.put(0,2, 402.145);

        cameraMatrix.put(1,0,0);
        cameraMatrix.put(1,1,578.272);
        cameraMatrix.put(1,2,221.506);
